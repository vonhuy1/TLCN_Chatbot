...
with open(r"content2.json", 'r', encoding="utf-8") as c:
...
def get_bot_response(user_input):
    ...
    model.load_state_dict(torch.load(r"D:\Download\chatgpt-streamlit-master\Model_2\32\32_100\saved_weights.pth", map_location=device),strict=False)
