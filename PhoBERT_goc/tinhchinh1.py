...
with open('D:\Download\chatgpt-streamlit-master\PhoBERT_goc\content.json', 'r', encoding="utf-8") as c:
...
def Chat(question):
    ...
    model.load_state_dict(torch.load('D:\Download\chatgpt-streamlit-master\PhoBERT_goc\saved_weights.pth', map_location=torch.device('cpu')))
