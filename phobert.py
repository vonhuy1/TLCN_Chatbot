...
with open(r"./PhoBERT_goc/content.json", 'r', encoding="utf-8") as c:
...
def get_bot_response(user_input):
    ...
    model.load_state_dict(torch.load(r"./PhoBERT_goc/saved_weights.pth", map_location=device),strict=False)
